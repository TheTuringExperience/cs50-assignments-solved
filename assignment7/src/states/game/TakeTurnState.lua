            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local currentHP, currentAttack, currentDefense, currentSpeed = self.playerPokemon:getCurrentStats()
                        ...
                        function()
                            ...
                            gStateStack:push(Menu{
                                ...
                                height = 120,
                                items = {
                                    {text = tostring(currentHP) .. " + " .. tostring(HPIncrease) .. " = " .. tostring(currentHP + HPIncrease)},
                                    {text = tostring(currentAttack) .. " + " .. tostring(attackIncrease) .. " = " .. tostring(currentAttack + attackIncrease)},
                                    {text = tostring(currentDefense) .. " + " .. tostring(defenseIncrease) .. " = " .. tostring(currentDefense + defenseIncrease)},
                                    {text = tostring(currentSpeed) .. " + " .. tostring(speedIncrease) .. " = " .. tostring(currentSpeed + speedIncrease)}
                                },
